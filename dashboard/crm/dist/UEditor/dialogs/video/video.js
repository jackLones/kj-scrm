...
(function(){
    ...
    function insertSingle(){
        ...
        // data-w="848"
        // frameborder="0"
        // data-src="https://v.qq.com/iframe/player.html?vid=g3075utl3qw&amp;auto=0"
        // allowfullscreen=""
        // src="https://v.qq.com/iframe/player.html?vid=g3075utl3qw"></iframe>
        var html = '<iframe class="video_iframe rich_pages" ' +
            'data-vidtype="2" ' +
            'style="z-index:1; " ' +
            'height="310" ' +
            'width="500" ' +
            'data-ratio="1.7666666666666666" ' +
            'data-w="'+ (width.value || 420) +'" ' +
            'frameborder="0" ' +
            'data-src="'+ url +'&amp;auto=0" ' +
            'allowfullscreen="" ' +
            'src="'+ url +'&amp;auto=0"></iframe>'
    ...
    function convert_url(url){
        ...
        if(url.split("?").length > 1) {
            ...
            var r = url.split("?")[1].match(reg);
            if(r != null) {
                return "https://v.qq.com/iframe/player.html?vid=" + r[2]
            }
        }
        url = utils.trim(url)
            ...
            .replace(/v\.qq\.com\/[\w]+\/[\w]+\/([\w]+)\.html/i, "v.qq.com/iframe/player.html?vid=$1")
            // .replace(/v\.qq\.com\/x\/page\/[\w]+\/[\w]+\/([\w]+)\.html/i, "v.qq.com/txp/iframe/player.html?vid=$1")
    ...
    function createPreviewVideo(url){
        ...
        if(conUrl.indexOf("v.qq.com/iframe/player.html?vid=") == -1) {
            $G("preview").innerHTML = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>'
        } else {
            $G("preview").innerHTML = '<iframe style="width: 420px; height: 280px" frameborder="0" src="'+ conUrl +'" allowFullScreen="true"></iframe>'
        }
    }
