<?php
	...
	/**
	 * This is the model class for table "{{%work_contact_way_baidu_date_user}}".
	 *
	 * @property int                     $id
	 ...
	 *
	 * @property WorkContactWayBaiduDate $date
	 */
	class WorkContactWayBaiduDateUser extends \yii\db\ActiveRecord
	{
		/**
		 * {@inheritdoc}
		 */
		...
		{
			return '{{%work_contact_way_baidu_date_user}}';
		}
		...
		public function rules ()
		{
			return [
				...
				[['date_id'], 'exist', 'skipOnError' => true, 'targetClass' => WorkContactWayBaiduDate::className(), 'targetAttribute' => ['date_id' => 'id']],
			];
		}
		...
		public function attributeLabels ()
		{
			return [
				'id'          => Yii::t('app', 'ID'),
				'date_id'     => Yii::t('app', '企业微信联系我百度表ID'),
				'time'        => Yii::t('app', '具体时间'),
		...
		{
			return $this->hasOne(WorkContactWayBaiduDate::className(), ['id' => 'date_id']);
		}
		...
		public static function setData ($data, $id)
		{
			...
			try {
				...
				foreach ($data as $key => $val) {
					...
					$dateUser              = new WorkContactWayBaiduDateUser();
