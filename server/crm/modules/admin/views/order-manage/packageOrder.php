				...
				<div class="ibox-content">
					...
					<div class="form-group">
						<div style="margin: 5px 0 15px;">
							<span style='color: #FF562D;font-weight: 500;'>只显示自有客户的套餐购买情况</span>
						</div>
						<div class="row">
							<form id="searchForm" method="get" action="/admin/order-manage/package-order">
								<div class="col-lg-2">
								...
								<div class="col-lg-2">
									<select class="form-control select" name="packId" id="packId">
										...
										<?php foreach($packageData as $pack):?>
											<option <?= ($packId == $pack['id'])?'selected':'';?> value="<?=$pack['id'];?>"><?=$pack['name'];?></option>
										<?php endforeach;?>
									</select>
								</div>
								<!--<div class="col-lg-2">
...
<script>
	...
	function clear(){
		window.location.href = '/admin/order-manage/package-order';
	}
	$(function(){
		$("#uid").chosen({
